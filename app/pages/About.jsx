...
const About = () => {
  return (
    <section className='w-screen h-screen overflow-hidden flex items-center justify-center pt-10 lg:pt-32' data-scroll-section>
