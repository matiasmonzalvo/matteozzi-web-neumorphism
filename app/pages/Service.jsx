  ...
  return (
    <section className='w-screen h-auto flex flex-col items-center justify-center' data-scroll-section>
      ...
      <div className="w-full h-auto px-10 gap-2 lg:gap-0 lg:px-20 pb-20 mt-10 flex lg:flex-row flex-col justify-center items-center">
        <div className="w-full h-[95%] bg-white shadow-2xl rounded-3xl flex flex-col justify-center items-center py-5 lg:py-16" data-scroll data-scroll-direction="horizontal" data-scroll-speed="2">
        ...
        <div className="w-full h-full bg-white shadow-2xl rounded-3xl lg:z-20 relative flex flex-col justify-center items-center py-5 lg:py-16" data-scroll>
          <div className="text-[8vw] lg:text-[3.5vw] p-[2vw] rounded-full bg-black text-white">
            <GiTruck />
          </div>
