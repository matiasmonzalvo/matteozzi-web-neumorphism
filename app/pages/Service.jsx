  ...
  return (
    <section className='w-screen h-auto flex flex-col items-center justify-center' data-scroll-section>
      ...
      <div className="w-full h-auto px-5 gap-2 lg:gap-0 lg:px-20 pb-20 mt-10 flex lg:flex-row flex-col justify-center items-center">
        <div className="service w-full bg-white shadow-2xl rounded-3xl flex flex-col justify-center items-center py-5 lg:py-14" data-scroll data-scroll-direction="horizontal" data-scroll-speed="2">
          <div className="text-[8vw] lg:text-[2.75vw] p-[1.5vw] rounded-full bg-black text-white">
